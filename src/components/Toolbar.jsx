...
const HIDE_KEY = 'moodboard-toolbar-hidden';
...
export default function Toolbar({
  ...
  const toggleHidden = () => {
    setCollapsed((c) => {
      try {
        localStorage.setItem(HIDE_KEY, c ? '0' : '1');
      } catch {
        /* private mode */
      }
      return !c;
  ...
  return (
    <div className={classes.join(' ')}>
      {/* hidden: only this small button stays, a click brings the bar back */}
      <button type="button" className="toolbar-orb tip" data-tip="Show toolbar" aria-label="Show toolbar" onClick={toggleHidden}>
      ...
      <div className="toolbar-group">
        ...
        {editingName ? (
          ...
          <button
            className="collaborator-chip tip"
            data-tip="Change your name"
      ...
      <button type="button" className="toolbar-hide tip" data-tip="Hide toolbar" aria-label="Hide toolbar" onClick={toggleHidden}>
